...
export function BlogPostContent({ post }: { post: PostDoc }) {
  ...
  // No `pickContent()` equivalent exists yet for richText (design D4's
  // playbook, A1 case-study-content.tsx precedent) — inline es-fallback.
  ...
  return (
    <article className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 md:py-20">
      ...
      <p className="mt-3 font-mono text-xs text-muted-foreground">
        {t.blog.publishedOn} {new Date(post.createdAt).toLocaleDateString(locale, { timeZone: 'UTC' })}
      </p>
